...
const buttonToggleTheme = document.querySelector('.button-toggle-theme')
...
function aplicarTema(){
    ...
    document.body.classList.toggle('light', temaAtual === 'light');
    document.querySelector('.container').classList.toggle('dark', temaAtual === 'dark');
    document.querySelector('.container').classList.toggle('light', temaAtual === 'light');
    document.querySelectorAll('.task').forEach(task => {
        task.classList.toggle('dark', temaAtual === 'dark')
        task.classList.toggle('light', temaAtual === 'light')
    })
}
...
buttonToggleTheme.addEventListener('click', alterarTema)
